...
JsonFunc::JsonFunc(QObject* parent) {
=======
#include "jsonfunc.h"
...
<<<<<<< HEAD
bool JsonFunc::authenticateUser(const QString filename,const QString username,const QString password) {
    // Load JSON file
    qInfo()<<filename<<username<<password;
    QFile file;
    file.setFileName(filename);
    if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
        qDebug() << "We Can't Open Json File";
        return false;
    }
    qInfo()<<filename<<username<<password;
=======
...
>>>>>>> eae4a420cfac246618c7e417b85bb208e83ae4fb
    ...
    if (FileDoc.isNull()) {
<<<<<<< HEAD
        qDebug() << "We Can't read Json File";
=======
...
<<<<<<< HEAD
        ...
        if (Userobject.contains("password") && Userobject["password"].toString() == password) {
            qDebug() << "The Authenticated Successful " << username;
            return true;
        }
    }
...
bool JsonFunc::checkObject(const QString& filename,const QString& FieldValue) {
=======
        QJsonObject UserObject = UserObject[username].toObject();
...
<<<<<<< HEAD
bool JsonFunc::printObjectFields(const QString &fileName,const  QString &objectName,const QString &request,QString &respond)
{
    //bool ok =false;
=======
...
<<<<<<< HEAD
                ...
                qWarning() << objectName << "not found in the JSON file.";
=======
                return true;
...
bool JsonFunc::PrintDataBase(const QString &fileName, QString &DataBase)
=======
    return false;
}
...
<<<<<<< HEAD
bool JsonFunc::EditField(const QString &fileName, const QString &ObjectKey, const QString &SpecificField, const QString &NewValue)
=======
...
<<<<<<< HEAD
bool JsonFunc::UpdateBalance(const QString& filename,const  QString &Usersfilename,const QString& username,const QString& amount) {
=======
...
<<<<<<< HEAD
QString JsonFunc::ViewHistory(const QString &fileName,  const QString &username, quint16 count)
=======
...
<<<<<<< HEAD
bool JsonFunc::AddNewObject( const QString &fileName, QVariantMap newObject,const QString &NewObjectName)
=======
...
bool JsonFunc::SaveHistory(const QString fileName, const QString username, const QString &amount)
=======
...
<<<<<<< HEAD
bool JsonFunc::TransferAmount(const QString &fileName, const QString &fromUsername, const QString &toUsername, const QString &transferamount)
{
  bool ok = false;
...
<<<<<<< HEAD
bool JsonFunc::deleteObject(const QString &filePath, const QString &objectKey)
=======
